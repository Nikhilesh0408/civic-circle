...
const SearchLawyers = () => {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-950 text-white' : 'bg-white text-gray-900'} transition-all duration-500`}>
      ...
      {/* Unique Particles — Squares & Diamonds */}
      ...
      <div className={`relative z-10 px-10 py-10 ${darkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
        ...
        >
          <input
            ...
            className={`px-4 py-3 rounded-xl border focus:outline-none focus:border-yellow-400 transition duration-300 ${darkMode ? 'bg-gray-800 text-white border-gray-700' : 'bg-white text-gray-900 border-gray-300'}`}
          />
          <input
            type="text"
          ...
          <motion.button
            ...
            className="px-6 py-3 bg-yellow-400 text-black font-bold rounded-xl hover:bg-yellow-300 transition duration-300"
          >
            🔍 Search
          </motion.button>
        </motion.div>
        ...
        {loading ? (
          ...
          >
            ...
            <motion.button
              ...
              onClick={() => navigate('/register')}
              className="mt-6 px-8 py-3 bg-yellow-400 text-black font-bold rounded-full hover:bg-yellow-300 transition duration-300"
            >
              Register as Advisor
            </motion.button>
          </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <motion.div
                      ...
                      className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-black text-2xl font-bold shadow-lg"
                    >
                  ...
                  <div className={`space-y-2 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    ...
                    {lawyer.bio && (
                      <p className={`line-clamp-2 mt-2 italic ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                        "{lawyer.bio}"
                      </p>
                    )}
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="mt-4 w-full py-2 bg-yellow-400 text-black font-bold rounded-xl hover:bg-yellow-300 transition duration-300"
                  >
                    View Profile →
                  </motion.button>
                </motion.div>

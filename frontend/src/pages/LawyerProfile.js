      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div
              className="w-32 h-32 bg-yellow-400 rounded-full items-center justify-center text-black text-5xl font-bold shadow-lg"
              style={{ display: lawyer.profile_photo && lawyer.profile_photo !== '' ? 'none' : 'flex' }}
            >
        ...
        <motion.div
          ...
          className={`border rounded-3xl p-8 mb-6 ${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-gray-100 border-gray-200'}`}
        >
          <h2 className="text-2xl font-bold mb-6 text-yellow-400">⚖️ Professional Details</h2>
        ...
        {lawyer.bar_certificate && lawyer.bar_certificate !== '' && (
          ...
          >
            ...
            {lawyer.bar_certificate.includes('.pdf') ? (
              <a
                href={lawyer.bar_certificate}
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-yellow-400 text-black font-bold rounded-full hover:bg-yellow-300 transition duration-300 inline-block"
              >
                📄 View Certificate (PDF)
              </a>
            ) : (
              <img
                src={lawyer.bar_certificate}
                alt="Bar Certificate"
